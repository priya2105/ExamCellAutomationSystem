...
export default class Add_Notice extends Component {
...
render(){
      ...
      return (
        <div>
          ...
          <Card style={{height:400,width:220,margin:130,marginTop:10,padding:60,background:"khadi",opacity:0.8,backgroundColor:"black" }}>
       <label  style={{color:"white",fontStyle:"",fontSize:50}} ><em> Notice:</em><br></br> </label>
        <textarea name="body"
        ...
        type="file" style={{marginLeft:67}} onChange={this.file.bind(this)} value={this.state.file}
